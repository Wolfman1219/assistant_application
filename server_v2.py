...
model = torch.load("C:/Users/ajbbo\Documents/assistant_application/v2/v5_1.pth", weights_only=False)
...
class VADProcessor:
    ...
    def process_chunk(self, audio_chunk):
        try:
            ...
            speech_prob = model(audio_tensor.reshape(1, 1, -1)).squeeze(0, 2).detach().numpy()
            ...
            speech_detected_now = np.mean(speech_prob) > 0.7
